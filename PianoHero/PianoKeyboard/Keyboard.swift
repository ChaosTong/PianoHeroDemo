...
@IBDesignable class Keyboard: UIView {
    ...
    @IBInspectable var octave: UInt8 = 0 {
        didSet {
    ...
    let blackKeyOffset: [CGFloat] = [0.0, 4.5, 0.0, 4.5, 0.0, 0.0, 4.5, 0.0, 4.5, 0.0, 4.5, 0.0]
    //[0.0, 4.0, 0.0, 5.5, 0.0, 0.0, 4.0, 0.0, 5.0, 0.0, 6.0, 0.0]
    ...
    private func pressAdded(newKey: PianoKey) {
        ...
        if newKey.pressed() {
            ...
            print("added \(String(describing: newKey.midiNoteNumber)), \(pressedKeys)")
        }
    }
    ...
    private func pressRemoved(key: PianoKey) {
        if key.released() {
            ...
            print("released \(String(describing: key.midiNoteNumber)), \(pressedKeys)")
        }
    }
